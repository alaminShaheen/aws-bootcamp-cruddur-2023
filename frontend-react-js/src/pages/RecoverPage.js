...
export default function RecoverPage() {
	...
	const onsubmit_send_code = async (event) => {
		...
		try {
			...
			if (!data.isPasswordReset && data.nextStep.resetPasswordStep === "CONFIRM_RESET_PASSWORD_WITH_CODE") {
	...
	const onsubmit_confirm_code = async (event) => {
		...
		setErrors("")
		try {
			const data = await confirmResetPassword({username, confirmationCode: code, newPassword: passwordAgain});
